    ...
    <footer className="bg-white dark:bg-black dark:text-white rounded-t-[4rem]">
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8">
        <div className="lg:flex lg:items-center lg:justify-between">
          <div className="flex justify-center text-orange-200 sm:justify-start dark:text-orange-200">
...
<p className="mt-4 max-w-md text-center leading-relaxed text-gray-500 sm:text-left lg:mt-0 dark:text-gray-400">
YouTube Moderator streamlines video management and editing, empowering creators and teams to collaborate efficiently.

Simplify your process, boost productivity, and elevate your YouTube content.
          </p></p>
        </div>
          ...
          <div className="text-center sm:text-left md:col-span-4 lg:col-span-2">
            ...
            <div className="mx-auto mt-8 max-w-md sm:ms-0">
              <p className="text-center leading-relaxed text-gray-500 ltr:sm:text-left rtl:sm:text-right dark:text-gray-400">
                Want to stay updated on the latest Youtube Moderator news, features,

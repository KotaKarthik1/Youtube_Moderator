...
export default function ContactUs() {
    const [isScrolled, setIsScrolled] = useState(60);
...
//   };
  ...
  return (
    <div className="max-w-full">
      ...
      <div className="mt-24 grid md:grid-cols-3 items-start gap-4 max-md:gap-12 max-w-6xl mx-auto py-6 bg-white font-[sans-serif]">
      <div className="px-4">
      ...
      <div className="bg-gray-800 rounded-3xl md:col-span-2 p-8">
        <h2 className="text-2xl text-yellow-300 font-semibold">Product or Service Inquiry</h2>
